  ...
  return (
    <section className="relative min-h-0 lg:min-h-[92vh] flex items-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container relative z-10 pt-28 sm:pt-32 md:pt-40 pb-[30px] px-4">
        ...
        <div className="hidden lg:block absolute bottom-0 right-4 z-10 w-[calc(40%+50px)] max-w-[570px] h-[80vh] max-h-[720px] -mb-[30px] pointer-events-none animate-fade-in" style={{ animationDelay: "0.2s" }}>
