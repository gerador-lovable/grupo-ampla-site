    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 py-16 md:py-24 px-4">
        <div className="max-w-2xl">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary-foreground leading-[1.1] mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Button
              asChild
              size="lg"
              className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg font-bold px-8 py-7 rounded-xl shadow-2xl shadow-accent/30 min-h-[56px] animate-pulse hover:animate-none"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 text-lg px-8 py-7 rounded-xl min-h-[56px]"
            >
              <a href={PHONE_URL}>
