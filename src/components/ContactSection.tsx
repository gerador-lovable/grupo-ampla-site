      ...
      <section id="contato" className="py-16 md:py-20 bg-secondary">
        <div className="container px-4">
          <div className="max-w-lg mx-auto text-center py-12">
            ...
            <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground min-h-[44px]">
      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg min-h-[52px]">
